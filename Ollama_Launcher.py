...
# machine state, just for a downloaded binary instead of a save file. Resolved relative to this
# file's own location (not cwd), the same reasoning DM_Persistence.py's _save_slot_dir already
# follows for Saves/.
VENDOR_DIR = os.path.join(os.path.dirname(os.path.abspath(__file__)), "vendor", "ollama")
